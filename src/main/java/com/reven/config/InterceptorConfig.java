...
public class InterceptorConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getInterfaceAuthCheckInterceptor()).addPathPatterns("/demoInterceptor/**");
        ...
        registry.addInterceptor(new SignInterceptor()).addPathPatterns("/demoInterceptor/**");
        super.addInterceptors(registry);
    }
