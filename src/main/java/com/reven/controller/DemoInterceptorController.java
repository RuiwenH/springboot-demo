...
/**
 * @ClassName: DemoInterceptorController
 * @author reven
 */
@RestController
@RequestMapping("/demoInterceptor")
public class DemoInterceptorController extends BaseController {
    private static Logger logger = LoggerFactory.getLogger(DemoInterceptorController.class);
    @Resource
