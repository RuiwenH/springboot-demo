...
//        logger.info("{}", DateUtil.getInteger(null, Calendar.YEAR));
    ...
    public static String getDate(String date) throws ParseException {
        return stringToString(date, null, DateStyle.YYYY_MM_DD);
    }
    ...
    public static String getTime(String date) throws ParseException {
        return stringToString(date, null, DateStyle.HH_MM_SS);
    }
    ...
    /**
     * 获取日期的时间。默认yyyy-MM-dd HH:mm:ss格式.
     * 
     * @param date 日期字符串
     * @return 时间
     * @throws ParseException 
    ...
    public static String getDateTime(String date) throws ParseException {
        return stringToString(date, null, DateStyle.YYYY_MM_DD_HH_MM_SS);
    }
